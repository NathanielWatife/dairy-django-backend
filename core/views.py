...
from core.models import Cow, CowBreed, Inseminator, CowInventory
from core.serializers import CowBreedSerializer, CowSerializer, InseminatorSerializer, CowInventorySerializer
