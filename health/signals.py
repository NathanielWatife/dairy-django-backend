...
from health.models import CullingRecord, QuarantineRecord, Disease, Recovery
...
def set_disease_recovery_record(sender, instance, action, reverse, pk_set, **kwargs):
    ...
    if action == 'post_add' and not reverse:
        for cow_id in pk_set:
            ...
            Recovery.objects.create(cow=cow, disease=instance, diagnosis_date=instance.date_reported)
